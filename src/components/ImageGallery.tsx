...
export default function ImageGallery({
  ...
  aspectMult = 2,
    ...
    const [reanimateImg, setReanimateImages] = useState<boolean>(true);
...
//   /* AUTO AJUST ASPECT SYSTEM NOT REALLY WORKING ://// :{{}} */
//   // useEffect(() => {
//   //   setIsReady(false)
...
//   //     const lower = targetHeight * 0.7
//   //     const upper = targetHeight * 1.0

//   //     console.log("measure nr " + adjustAttempts + ": " + measured + " target:" + targetHeight*0.85)
      
//   //     if (measured >= lower && measured <= upper) {
//   //       setIsReady(true)
        
//   //       console.log("MEASURE WITHIN TARGET")
//   //       return
//   //     }
      
//   //     if (adjustAttempts >= maxAdjustAttempts) {
//   //       console.log("MAX RESIZE ATTEMPTS REACHED")
//   //       setIsReady(true)
//   //       return
//   //     }
...
//   //     const damping = 0.3;
//   //     let proportion = (targetHeight / (measured || 1))
//   //     let newAspect = aspectMult * (1+((proportion-1) * damping));
      
//   //     newAspect = clamp(newAspect, 1, 8)
//   //     if (Math.abs(newAspect - aspectMult) < 0.01) {
//   //       console.log("NO ASPECT CHANGE DETECTED")
//   //       setIsReady(true)
//   //       return
//   //     }
